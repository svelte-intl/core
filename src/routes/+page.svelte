...
{#if false === getLoading()}
	<div class="mx-auto mt-12 max-w-150">
		<h1 class="mb-6 text-3xl font-bold">
			{t('active_locale', { locale: getLocale() })}
		</h1>

		<p>
			Hello, welcome to the Svelte Intl package! This package provides
			internationalization (i18n) support for Svelte applications, allowing you
			to easily manage translations and locale-specific formatting. Below is an
